...
@Component({
  selector: 'InventoryWarehouseData',
  templateUrl: './InventoryWarehouseData.component.html',
  styleUrls: ['./InventoryWarehouseData.component.css'],
})
export class InventoryWarehouseDataComponent extends BaseComponent implements OnInit {
  title: string = "Báo cáo kiểm kê";
  ...
  getDataReport(){
    ...
    this._service.getInventoryWarehouseData(body).then(res=>{
      console.log(res);
      if(res?.data){
        const data = res.data;
