...
@Component({
  selector: 'out-coming-supplier-note-add-edit-dialog',
  templateUrl: './out-coming-supplier-note-add-edit-dialog.component.html',
  styleUrls: ['./out-coming-supplier-note-add-edit-dialog.component.css'],
})
export class OutComingSupplierNoteAddEditDialogComponent extends BaseComponent implements OnInit {
  listPaymentType: any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OutComingSupplierNoteAddEditDialogComponent>,
    ...
    this.formData = this.fb.group({
      ...
      loaiPhieu: [LOAI_THU_CHI.CHI_TRA_NO_NHA_CUNG_CAP],
      amount: [0],
      dienGiai: [''],
      paymentTypeId: [0],
  ...
  async openAddEditInReturnSupplierNoteAddEditDialog() {
    this.closeModal();
    const config = {
      data: {
        supplierId: this.formData.value?.supplierId
